        ...
        $(function () {
            ...
            var context_gl = {
                ...
                "tipos" : [
                    ...
                    {"name":"Pares",
                        "id":"pares",
                        "text":"Se facemos unha busca para encontrar a similaridade entre pares de palabras, o sistema ofrece un novo campo para introducir una segunda palabra. Devolve o valor de similaridade entre as dúas palabras comparadas durante o intervalo de tempo escollido."},
                    {"name":"Histórico",
                        "id":"historico",
                        "text":"Ao igual que na busca simple, o usuario introduce unha palabra e un período de tempo. Sen embargo, o sistema especifica os valores de similaridade ano a ano en lugar de dar a media de todo o período. Por outro lado, visualízanse todas as palabras relacionadas coa palabra de busca durante o período definido en lugar das 20 primeras. Por defecto, visualízase o histórico de similaridade das tres con valores de similaridade media máis alta."},
                    {"name":"Nube",
                        "id":"nube",
                    ...
                    {"name":"Transitiva",
                        "id":"transitiva",
                        "text":"Esta busca baséase na propiedade transitiva. Para clarificar isto imaxinemos unha estructura de árbore. No primero nivel encóntrase a raíz, é dicir a palabra buscada, mentres que no segundo nivel están as 20 palabras cun nivel de similaridade máis alto. Tense tamén en conta un terceiro nivel, formado polas palabras que son similares ás do segundo nivel. Usando a propiedade transitiva, as palabras do primeiro nivel terán un grao de similaridade coas palabras do 3 nivel calculado mediante a suma dos valores de similaridade e aplicando unha normalización dos resultados, obtendo así valores entre 0 e 100."}
                ]
            ...
            var context_es = {
                ...
                "tipos" : [
                    ...
                    {"name":"Pares",
                        "id":"pares",
                        "text":"Si hacemos una búsqueda para encontrar la similaridad entre pares de palabras, el sistema ofrece un nuevo campo para introducir una segunda palabra. Devuelve el valor de similaridad entre las dos palabras comparadas durante el intervalo de tiempo escogido."},
                    {"name":"Histórico",
                        "id":"historico",
                    ...
                    {"name":"Transitiva",
                        "id":"transitiva",
                        "text":"Esta búsqueda se basa en la propiedad transitiva. Para clarificar esto imaginemos una estructura de árbol. En el primer nivel se encuentra la raíz, es decir la palabra buscada, mientras que en el segundo nivel están las 20 palabras con un nivel de similaridad más alto. Se toma también en cuenta un tercer nivel, formado por las palabras que son similares a las del segundo nivel. Usando la propiedad transitiva, las palabras del primer nivel tendrán un grado de similaridad con las palabras del 3 nivel calculado mediante la suma de los valores de similaridad y aplicando una normalización de los resultados, obteniendo así valores entre 0 y 100."}
                ]
